...
import gg.mc.network.packets.SPacketDespawnPlayer;
import gg.mc.network.packets.SPacketSetBlock;
...
public class World {
	...
	public World(String name, short length, short depth, short height) {
		...
		spawn = new Position(0, 0, 0, (byte) 0, (byte) 0);
	}
	...
	public void reclaimEid(byte id) {
		broadcastWorldPacket(new SPacketDespawnPlayer(id));
	...
	public void setBlockAt(short x, short y, short z, byte block) {
		...
		SPacketSetBlock update = new SPacketSetBlock(x, y, z, block);
